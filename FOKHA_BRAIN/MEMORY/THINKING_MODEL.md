...
> Source: Google Sheet `Fokha - Idea Inbox` / tab `THINKING_MODEL`.
> Synced: 2026-09-04.
...
| TM-004 | Integrity Before Speed | الدقة ونزاهة البيانات والأمان تسبق تحسين السرعة. | Locks, idempotency, source-of-truth and rollback foundations. | يرفض تحسين أداء يضعف الصلاحيات أو سلامة البيانات. | TrendOS D-008 + integrity-v1 code | Execution | High | Active |
