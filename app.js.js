...
(function(){
  ...
  function openFinalInvoice(row){
    ...
    try{
      ...
      u.searchParams.set('name', su.name); u.searchParams.set('username', su.username); u.searchParams.set('token', su.token || ''); u.searchParams.set('v','es37-v1912-final-pending-search');
      window.open(u.toString(), 'Matbagy_EasyStore_Invoice');
    }catch(e){}
  }
