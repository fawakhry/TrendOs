(function () {
  ...
  const UI_VERSION = 'V1914_EASYSTORE_DEBT_RECONCILE';
...
Trend Mall`;
  ...
  function openEasyStoreLaserForInvoice() {
    ...
    window.open("https://fawakhry.github.io/EasyStore/?screen=dept&mode=laser&name=" + user + "&username=" + user + "&token=" + token + "&department=ليزر&customer=" + customer + "&orderId=" + orderId + "&v=es39-v1914-legacy-debt-reconcile-20260810", "_blank");
  }
...
(function(){
  ...
  function openEasyStoreLaser(row){
    ...
    u.searchParams.set('v', window.MATBAGY_EASYSTORE_VERSION_PARAM || 'es39-v1914-legacy-debt-reconcile-20260810');
  ...
  function openFinalInvoice(row){
    ...
    u.searchParams.set('name', cu.name); u.searchParams.set('username', cu.username); u.searchParams.set('token', cu.token || ''); u.searchParams.set('v', window.MATBAGY_EASYSTORE_VERSION_PARAM || 'es39-v1914-legacy-debt-reconcile-20260810');
...
(function(){
  ...
  function openFinalInvoice(row){
    ...
    try{
      ...
      u.searchParams.set('name', su.name); u.searchParams.set('username', su.username); u.searchParams.set('token', su.token || ''); u.searchParams.set('v', window.MATBAGY_EASYSTORE_VERSION_PARAM || 'es39-v1914-legacy-debt-reconcile-20260810');
      window.open(u.toString(), 'Matbagy_EasyStore_Invoice');
    }catch(e){}
  }
...
(function(){
  window.TRENDOS_PATCH_VERSION = 'V1914_EASYSTORE_DEBT_RECONCILE';
  window.TRENDOS_LOADED_APP_VERSION = 'TrendOS V1914 EasyStore Debt Reconcile';
  window.MATBAGY_BUILD_VERSION = 'TrendOS V1914 EasyStore Debt Reconcile';
  window.MATBAGY_BATCH_VERSION = 'V1914_EASYSTORE_DEBT_RECONCILE';
  window.MATBAGY_UI_THEME_VERSION = 'V1914_EASYSTORE_DEBT_RECONCILE';
})();
