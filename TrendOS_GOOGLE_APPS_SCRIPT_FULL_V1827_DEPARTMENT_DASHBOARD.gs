 ...
 * نسخة كاملة موحدة V1827 لإصلاح قراءة معرفة واتس AI + متابعة كل قسم:
 * 1) تسجيل الدخول
...
function dashboardMatchesScreen_(screen, department, heatPress) {
  ...
  if (screen === "print") return department === "طباعة";
  if (screen === "laser") return department === "ليزر";
  if (screen === "press") return department === "مكبس" || !!heatPress;
  return true;
}
