...
vm.createContext(ctx);vm.runInContext(foundation,ctx);vm.runInContext(dashboard,ctx);
const snap={
 lines:[
 ...
 drafts:[
  {orderId:'4000',status:'تم التقفيل',subtotal:100},
  {orderId:'7000',status:'يحتاج تسعير/اعتماد',subtotal:0},
  {orderId:'7000',status:'يحتاج تسعير/اعتماد',subtotal:0}
 ],
