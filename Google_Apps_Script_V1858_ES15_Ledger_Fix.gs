...
function saveAccountingDeptLine_(e) {
  ...
  const billingStatus = normalize_(e.parameter.billingStatus) || "جاهز للفوترة";
...
function easyStoreSystemHealth_(e) {
  ...
  return { success:true, message:"النظام سليم", sheets:Object.keys(sh).concat(["حسابات - كشف العملاء والموردين"]), version:"V1858 ES15 Ledger Fix", permissions:{ mode:auth.mode, canEnterPurchaseInvoice: accountingCanSavePurchaseV1857_(auth), canSeeCosts: auth.mode === "full", canEditLedger:accountsCanEditV1858_(auth) } };
}
