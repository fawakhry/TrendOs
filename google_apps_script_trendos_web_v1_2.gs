...
function createManualOrder_(e){
  ...
  appendOrder_(ss, { orderId, now, customerName, customerPhone, department, itemName, qty, priority, status, assignedTo, notes });
  appendLine_(ss, { orderId, lineId, now, customerName, customerPhone, department, itemName, qty, priority, status, assignedTo, notes });
