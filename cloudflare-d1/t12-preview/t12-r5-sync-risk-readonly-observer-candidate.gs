...
function trendosR5SyncRiskReadOnlyObserverCandidate20260920() {
  ...
  var report={
    ...
    note:'READ ONLY. Healthy dimension/trigger checks do not prove full row parity, future stability, or Apps Script Property quota; a lag can clear on next scheduled tick. Do not manually restart on this result.'
  };
