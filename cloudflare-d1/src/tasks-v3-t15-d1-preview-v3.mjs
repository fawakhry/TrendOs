// TrendOS Tasks V3 T1.5 v3 — isolated D1 read replica.
// Read path never calls Google. Refresh uses one status call (with one retry on failure)
// through the qualified T1 preview source. Sheets remain authoritative.
...
export async function callTasksV3T1Source({
  ...
  if (typeof fetchImpl !== 'function') {
    return failure('TASKS_V3_T15_SOURCE_FETCH_UNAVAILABLE', '', 503);
  }
