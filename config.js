...
window.MATBAGY_EDGE_ORDERS_ALLOWED_SCREENS = ['print','laser'];
...
trendLoadModuleV1932('trendEdgeOrdersReadV1Loader','trendos-edge-orders-read-v1.js?v=20260913-t9-print-laser1');
