...
window.MATBAGY_EASYSTORE_VERSION_PARAM = 'es33-v1890-version-lock';
...
// Clean build flags
window.MATBAGY_BUILD_VERSION = 'TrendOS V1890 Stable Version Lock';
...
window.MATBAGY_V1890_VERSION_LOCK = true;
window.MATBAGY_V1860_ES17_INTERNATIONAL_UI_THEME = true;
window.MATBAGY_UI_THEME_VERSION = 'V1890_VERSION_LOCK';
